...
//builder.Services.AddScoped(sp => new HttpClient { BaseAddress = new Uri("http://carnesiapanelapi.carnesia.com/api/") });

//meesagehandler

builder.Services.AddHttpClient("RetailSuite", client =>
{
    client.BaseAddress = new Uri("http://carnesiapanelapi.carnesia.com/api/");
